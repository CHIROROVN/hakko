...
<table width="960" border="0" align="center" cellpadding="5" cellspacing="0">
  <tbody>
	...
	<tr>
	  <td align="center">
		<input type="button" onClick="location.href='{{route('backend.infos.regist_save')}}'" id="btn-save" value="保存する">
		<input type="button" id="btn_back" onClick="location.href='{{route('backend.infos.regist_back')}}'" value="戻る">
	   </td>
	</tr>
	<tr>
	  <td align="center">&nbsp;</td>
