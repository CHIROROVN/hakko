      ...
      <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input type="radio" id="info_list_img_radio1" name="info_list_img_radio" value="1" @if(old('info_list_img_radio') == 1) checked @else checked @endif >
                登録されている画像をそのまま利用 → 
              ...
              @endif
              <br>
              <input type="radio" id="info_list_img_radio2" name="info_list_img_radio" value="2" @if(old('info_list_img_radio') == 2) checked @endif >
                次の画像に差し替える :               
              ...
              <br>
              <input type="radio" id="info_list_img_radio3" name="info_list_img_radio" value="3" @if(old('info_list_img_radio') == 3) checked @endif >
                登録されている画像を削除する
          ...
          <tr>
            ...
            <td>
              <input type="radio" id="info2_file_radio1" name="info2_file_radio" value="1" @if(old('info2_file_radio') == 1) checked @else checked @endif >
                登録されているファイルをそのまま利用 → 
              @if(old('info2_file'))
              ...
              @endif
              <br>
              <input type="radio" id="info2_file_radio2" name="info2_file_radio" value="2" @if(old('info2_file_radio') == 2) checked @endif >
                次のファイルに差し替える : 
              ...
              <br>
              <input type="radio" id="info2_file_radio3" name="info2_file_radio" value="3" @if(old('info2_file_radio') == 3) checked @endif >
                登録されているファイルを削除する
          ...
          <tr>
            ...
            <td >
              <input type="radio" id="info3_img_radio1" name="info3_img_radio" value="1" @if(old('info3_img_radio') == 1) checked @else checked @endif >
                登録されている画像をそのまま利用 → 
                @if(old('info3_img'))
                ...
                @endif
                <br>
                <input type="radio" id="info3_img_radio2" name="info3_img_radio" value="2" @if(old('info3_img_radio') == 2) checked @endif >
                次の画像に差し替える :
                ...
                <br>
                <input type="radio" id="info3_img_radio3" name="info3_img_radio" value="3" @if(old('info3_img_radio') == 3) checked @endif >
                登録されている画像を削除する
          ...
          <tr>
            ...
            <td >
              <input type="radio" id="info3_file_radio1" name="info3_file_radio" value="1" @if(old('info3_file_radio') == 1) checked @else checked @endif >
                登録されているファイルをそのまま利用 → 
                @if(old('info3_file'))
                <a href="{{ asset('public') }}{{old('info3_file')}}"  target="_blank">ファイルビュー</a>
                ...
                @endif
                <br>
                <input type="radio" id="info3_file_radio2" name="info3_file_radio" value="2" @if(old('info3_file_radio') == 2) checked @endif >
                次のファイルに差し替える :
                ...
                <br>
                <input type="radio" id="info3_file_radio3" name="info3_file_radio" value="3" @if(old('info3_file_radio') == 3) checked @endif >
                登録されているファイルを削除する
